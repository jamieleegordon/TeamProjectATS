 ...
 * @author Jamie-Lee
 *
 * This class is a form used to display global interline sales reports,
 * where managers and advisors may decide to search for a particular sale or print the report.
 */
public class GlobalInterline extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Global Interline Report");
        ...
        jLabel1.setText("Global Interline Report");

        reportTable.setModel(new javax.swing.table.DefaultTableModel());
        r.DisplayGlobalInterline(reportTable);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {
        r.ClearTable(reportTable);
        r.searchGlobalInterline(reportTable, idBox.getText());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GlobalInterline.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
