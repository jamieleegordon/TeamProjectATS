 ...
 * @author Jamie-Lee
 *
 * This is a form used to allow office managers to enter an advisor’s ID to generate their individual interline sales reports.
 */
public class EnterInterline extends javax.swing.JFrame {

    /**
     * Creates new form EnterInterline
     */
    public EnterInterline() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterInterline.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
